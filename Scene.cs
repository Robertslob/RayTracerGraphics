...
namespace Application
{
    class Scene
    {
        ...
        public Scene()
        {
            ...
            allPrimitives.Add(new Sphere(new Vector3(0, 1, 0), 1, new Material(new Vector3(0, 0.5f, 0.5f), 0.6f, 0.01f, false)));         
            allPrimitives.Add(new Sphere(new Vector3(-3, 1, 0), 1, new Material(new Vector3(0.5f, 0, 0), 0.0f, 0.0f, false)));
            allPrimitives.Add(new Sphere(new Vector3(3, 1, 0), 1, new Material(new Vector3(0, 0, 0.8f), 0.0f, 0.0f, false)));
        }

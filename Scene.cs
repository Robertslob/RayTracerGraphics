...
namespace Application
{
    class Scene
    {
        ...
        public Scene()
        {
            ...
            allPrimitives.Add(new Plane(new Vector3(0, 1, 0), new Vector3(0, 0, 0), new Material(new Vector3(0.5f, 0.5f, 0.5f), 0f, 0.2f)));
            allPrimitives.Add(new Sphere(new Vector3(0, 1, 0), 1, new Material(new Vector3(0, 1, 0), 0.5f, 0.2f)));
